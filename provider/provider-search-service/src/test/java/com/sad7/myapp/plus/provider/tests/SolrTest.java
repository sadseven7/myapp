package com.sad7.myapp.plus.provider.tests;


import com.sad7.myapp.plus.provider.ProviderSearchServiceApplication;
import com.sad7.myapp.plus.provider.domain.TbItemResult;
import com.sad7.myapp.plus.provider.mapper.TbItemResultMapper;
...
@SpringBootTest(classes = ProviderSearchServiceApplication.class)
...
//        List<TbItemResult> tbItemResultlist = tbItemResultMapper.selectAll();
//        for (TbItemResult tbItemResult : tbItemResultlist){
...
//        document.addField("tb_item_title", "new88- 三星 W999 黑色 电信3G手机 双卡双待双通");
//
//        try {

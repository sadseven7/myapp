...
import com.sad7.myapp.plus.provider.service.fallback.UmsAdminServiceFallback;
...
public class UmsAdminServiceImpl implements UmsAdminService {
     ...
     */
    @Override
    @SentinelResource(value = "getByUsername", fallback = "getByUsernameFallback", blockHandlerClass = {UmsAdminServiceFallback.class})
